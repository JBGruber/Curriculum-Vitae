...
\textbf{
  ...
  \ico{Mastodon} \href{https://fosstodon.org/@JBGruber}{@JBGruber@fosstodon.org} | 
...
Both topics is closely connect to my interest in media discourse as well as representation of dissent and demonstrations in the media.
